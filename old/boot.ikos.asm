...
load_sector:
        ...
        cmp byte[sector_per_track], 0xFF ;7c8a
        je .use_EDD
        push bx cx si
...
load_file_data:
 ...
 .file_end:
        ...
        ret
 @@:
        mov di, 0x8000 / 16 ;по этому адресу находится список секторов файла
        call load_sector ;7d75
        mov si, di
        mov cx, 512 / 8 - 1
 .load_sector:
        lodsw
...
; Получение карты памяти from 80cc
get_memory_map:
        mov di, memory_map
        xor ebx, ebx
@@:
